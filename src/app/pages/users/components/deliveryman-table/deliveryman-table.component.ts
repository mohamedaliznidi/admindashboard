...
@Component({
  selector: 'app-deliveryman-table',
  templateUrl: './deliveryman-table.component.html',
  styleUrls: ['./deliveryman-table.component.scss'],
})
export class DeliverymanTableComponent implements OnInit {
